...
\usepackage[bodytextleadingratio=1.67]{zhlineskip}
\usepackage{titlesec}
\usepackage{zhnumber}
\usepackage{abstract}
...
\makeatletter
\newcommand{\if@sectionstar}[2]{ % are we in a \section* or \section?
...
\renewcommand{\sectionmark}[1]{\markboth{\if@sectionstar{第\chinese{section}章~}{}#1}{}}
\makeatother
...
\RenewDocumentCommand{\section}{s o m}{%
  \IfBooleanTF{#1}
    ...
    {\setcounter{@instarsection}{0} % mark that we are in a \section
     \IfValueTF{#2}% \section
